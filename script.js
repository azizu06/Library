...
function newBook() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (author.validity.valueMissing) {
      author.setCustomValidity("Please enter a valid author name.");
    }
    if (year.validity.valueMissing) {
      year.setCustomValidity("Please enter a valid publication year.");
    }
    if (page.validity.valueMissing) {
      page.setCustomValidity("Please enter a valid number of pages.");
    }
